...
namespace Task2.ViewModels
{
	public class MainWindowViewModel : ViewModelBase
	{
		...
		{
			Th1 = ("Th1", "Start Th1").ToTuple();
			Th2 = ("Th2", "Start Th2").ToTuple();
			Th3 = ("Th3", "Start Th3").ToTuple();
			Th4 = ("Th4", "Start Th4").ToTuple();
			Th5 = ("Th5", "Start Th5").ToTuple();
			Th6 = ("Th6", "Start Th6").ToTuple();
			Th7 = ("Th7", "Start Th7").ToTuple();
			Th8 = ("Th8", "Start Th8").ToTuple();
			Th9 = ("Th9", "Start Th9").ToTuple();
			Th10 = ("Th10", "Start Th10").ToTuple();
			ConsoleOutput = "";
