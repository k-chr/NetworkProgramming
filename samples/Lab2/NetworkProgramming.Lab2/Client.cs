...
namespace NetworkProgramming.Lab1
{
   ...
   {
      protected override string OnSendErrorMessage => "Cannot send provided message to server due to connection issues!\n";
      ...
      public Client(string address, int port, ManualResetEvent manualResetEvent) : base(address, port, manualResetEvent)
      {
      }
   }
