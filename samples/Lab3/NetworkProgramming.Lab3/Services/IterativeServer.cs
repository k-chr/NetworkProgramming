...
using NetworkProgramming.Lab3.Extensions;
...
namespace NetworkProgramming.Lab3.Services
{
	public class IterativeServer
	{
		...
		public void StartService(string ip, int port, string interfaceName = "") =>
			DisposeCurrentSession().StartListen(ip, port, interfaceName);
